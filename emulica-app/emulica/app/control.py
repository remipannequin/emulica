...
from emulica.core import emuML, controler
...
class EmulicaControl:
    ...
    def control_add_import(self):
        ...
        snippet = """from emulica.core.emulation import Request, Report\n"""
    ...
    def control_add_class(self):
        ...
        snippet = """class ControlProcess:\n    def run(self, model):\n        from emulica.core.emulation import Report, Request, wait_idle\n        """
